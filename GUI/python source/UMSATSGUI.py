...
#
#   File Description:
#       This file was generated by PAGE and defines the GUI layout.
#
#   History
#   2018-05 by Huy Bui.
#       -   Created using PAGE.
...
#       -   Update callbacks to point to correct functions.
...
class UMSATS:
    def __init__(self, top=None):
        ...
        self.btnComms1.bind('<Button-1>', lambda e: UMSATSGUI_support.sendComms(e,self.frameTerminal,UMSATSGUI_support.COMMS_START))
        ...
        self.btnComms2.bind('<Button-1>', lambda e: UMSATSGUI_support.sendComms(e,self.frameTerminal,UMSATSGUI_support.COMMS_STOP))
