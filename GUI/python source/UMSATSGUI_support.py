...
# Dont hit send with no values in the boxes
...
def sendComms(e,frame,cmd):
    #print("sending coms stuff")
    writeCommand(frame.children['!entry'], frame.children['!listbox'], 1,"COMMS " + str(cmd) + " " + payloadValueInput.get())
